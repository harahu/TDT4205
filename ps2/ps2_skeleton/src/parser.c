...
static const yytype_uint16 yyrline[] =
{
      ...
      63,    71,    76,    84,    89,    98,   103,   109,   114,   120,
     125,   133,   142,   147,   152,   157,   162,   167,   172,   179,
     185,   192,   200,   207,   214,   220,   226,   235,   243,   249,
     255,   263,   269,   275,   281,   287,   292,   296,   301,   306,
     314,   321,   326,   333,   340,   346
};
#endif
...
#line 125 "src/parser.y"
    {
							(yyval) = (node_t *) malloc ( sizeof(node_t) );
							node_init ( (yyval), STATEMENT, NULL, 2 );
							(yyval)->children[0] = (yyvsp[(1) - (2)]);
							(yyval)->children[1] = (yyvsp[(2) - (2)]);
						  ;}
    break;
...
#line 179 "src/parser.y"
    {
							...
							(yyval)->children[0] = (yyvsp[(2) - (4)]);
							(yyval)->children[1] = (yyvsp[(3) - (4)]);
						  ;}
    break;
...
#line 192 "src/parser.y"
    {
							...
							(yyval)->children[0] = (yyvsp[(1) - (4)]);
							(yyval)->children[1] = (yyvsp[(4) - (4)]);
						  ;}
    break;
...
#line 340 "src/parser.y"
    {
				(yyval) = (node_t *) malloc ( sizeof(node_t) );
				node_init ( (yyval), NUMBER_DATA, number_data(), 0 );
			  ;}
    break;
